export default {
  ...
  sequence: {
    ...
    scenes: [
      {
        id: 1,
        beforeTitle: '【1994年大學推薦甄選學測】',
        title: '下列那一項敘述最能說明三民主義是「國家發展」的指導綱領？',
        options: [
          {
      ...
      {
        id: 2,
        beforeTitle: '【1994年航海人員、漁船船員、船舶電信人員特考】',
        title: '就民族主義的功能來說，民族主義又可作什麼闡釋？',
        options: [
          {
            title: '平天下主義'
          },
      ...
      {
        id: 3,
        beforeTitle: '【1993年警察特考】',
        title: '先總統　蔣公說：「團結在三民主義之下，革命才能成功，中國才能達到自由平等的地位。」由此可見三民主義是什麼主義？',
        options: [
          {
            title: '平等主義'
          },
      ...
      {
        id: 4,
        beforeTitle: '【1994年國安局特考】',
        title: '就歷史進化的道理言，國父是認為民權是如何產生的？',
        options: [
          {
            title: '天賦與生俱來'
          },
      ...
      {
        id: 5,
        beforeTitle: '【1994年專門職業及技術人員普考】',
        title: '國父認為人類要能夠生存，須有兩件最大的事，這兩件最大的事是指什麼？',
        options: [
          {
            title: '教和衛'
          },
      ...
      {
        id: 6,
        beforeTitle: '【1992年專門職業及技術人員普考】',
        title: '為使選舉能達到選賢與能的理想，所以應當？',
        options: [
          {
            title: '以學歷限制選舉人資格'
          },
      ...
      },
      {
        id: 7,
        beforeTitle: '【1994年航海人員、漁船船員、船舶電信人員特考】',
        title: '歐美的三權分立制，其所以容易形成國會專制，那是因為什麼緣故？',
        options: [
          {
            title: '國會擁有質詢權與預算權'
          },
      ...
      {
        id: 8,
        beforeTitle: '【1993年司法政風人員特考】',
        title: '國父在民族主義中指出，我國自何時而後，都是一個民族造成一個國家？',
        options: [
          {
            title: '周朝'
          },
      ...
      {
        id: 10,
        beforeTitle: '【1996年高等暨普通中醫師檢定考試】',
        title: '中國以前沒有自由這個名詞，但國父說有一種跟自由相彷彿的固有名詞是？',
        options: [
          {
            title: '為所欲為'
          },
