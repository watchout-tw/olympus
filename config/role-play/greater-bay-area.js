export default {
  ...
  sequence: {
    ...
    scenes: [
      ...
      {
        id: 4,
        beforeTitle: '青春無敵。在街上尋找愛情小說的靈感，看見有一對男女在鬧分手，警察也正在調停，很多人圍著湊熱鬧。',
        title: '要不要去看一下？',
        image: {
      ...
      {
        id: 5,
        beforeTitle: '先別管別人的閒事，為自己的生活努力。為幫補學費和生活費，幾個同學打算一起開網店賺一點錢。',
        title: '開怎樣的店好？',
        image: {
      ...
      },
      {
        ...
        subtitle: '你是郭春生',
        description: '適用《逃犯條例》罪類44：串謀犯欺詐罪。港商郭春生1996年以公司名義與招商銀行在香港簽訂了抵押貸款協議。郭的公司其後無力還款，招商銀則沒有循香港司法程序追討，反而在大陸起訴郭春生。2009年，郭春生被中國法院以「合同詐騙罪」刑事起訴，一審被判無期徒刑及沒收所有財產；2012年獲減刑至18年。',
        image: {
      ...
      },
      {
        ...
        subtitle: '你是天一',
        description: '適用《逃犯條例》罪類39：與婦女及女童有關的罪行。2017年，作家天一的男男同性戀小說《攻佔》在網路上熱賣，經國家新聞出版廣電總局鑒定，定性《攻佔》為「淫穢出版物」，作者被判監禁10年6個月。',
        image: {
      ...
      },
      {
        ...
        subtitle: '你是劉成昆',
        description: '適用《逃犯條例》罪類7：刑事恐嚇。2018年，北京的自媒體人劉成昆因在網上發表了兩篇小說，被認為影射了內蒙古伊利集團董事長潘剛涉腐外逃，被呼和浩特警方跨省抓捕，而尋釁滋事罪判處1年8個月徒刑。',
        image: {
      ...
      },
      {
        ...
        subtitle: '你是吳向洋',
        description: '適用《逃犯條例》罪類11：與公司有關的法律所訂的罪行。男子吳向洋在未取得《增值電信業務經營許可證》下，利用淘寶網開設網店及開設網站「凡狗」，向用戶出租或銷售VPN軟件和VPN路由器硬件，被判有期徒刑5年6個月。',
        image: {
