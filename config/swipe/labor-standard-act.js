export default {
  ...
  cards: [
    ...
    },
    {
      type: 'question',
      title: '加班換補休',
      question: '有人說：「法律規定加班可以換補休，那以後加班費都領不到了啦！」QQ',
      answer: 'NO',
      options: {
        left: {
          type: 'NO',
    ...
    },
    {
      type: 'question',
      title: '休息日加班費',
      question: '有人說：「休息日加班費費率變低，加班費要減少了啦！」QQ',
      answer: 'NO',
      options: {
        left: {
          type: 'NO',
    ...
    },
    {
      type: 'question',
      title: '加班上限',
      question: '有人說：「加班工時上限提高，以後每個月都要多加班八小時了啦！」QQ',
      answer: 'NO',
      options: {
        left: {
          type: 'NO',
    ...
    },
    {
      type: 'question',
      title: '早就七休一',
      question: '有人說：「『七休一』條文從《勞基法》訂定時就存在，已經實施超過三十年！」',
      answer: 'YES',
      options: {
        left: {
          type: 'NO',
    ...
    },
    {
      type: 'question',
      title: '休息八小時',
      question: '有人說：「要累死了，以後每個人下班後休息八小時就可以繼續上班⋯」QQ',
      answer: 'NO',
      options: {
        left: {
          type: 'NO',
    ...
    },
    {
      type: 'question',
      title: '工會和勞資會議',
      question: '有人說：「我公司沒工會，也沒開過勞資會議，放寬七休一、加班時數上限調整跟我沒關係！」',
      answer: 'YES',
      options: {
        left: {
          type: 'NO',
    ...
    },
    {
      type: 'question',
      title: '勞檢',
      question: '有人說：「檢舉沒用啦！公司違反勞基法，政府都不來勞檢！」',
      answer: 'NO',
      options: {
        left: {
          type: 'NO',
