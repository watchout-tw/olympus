export default {
  ...
  cards: [
    ...
    },
    {
      type: 'question',
      title: '練習題',
      question: '先練習一次吧！在卡片上往左滑或按紅色按鈕，表示不同意。往右滑或按綠色按鈕，表示同意。',
      image: {
        url: '/swipe/instruction.png',
        width: 200,
        height: 100
      },
      answer: 'YES',
    ...
    },
    {
      ...
      more: [
        {
          type: 'markdown',
          content: '#### 先講結論\n\n「七休一」相關條文確實於1984年《勞基法》訂定時就已存在，但其實1986年內政部勞工司（今勞動部）就已經以函釋放寬，直至2016年9月蔡英文政府廢除舊函釋、另訂新函釋前，「七休一」一直都沒真正落實。而在3月1日勞動新制上路後，目前僅有經[勞動部公告業別](https://www.mol.gov.tw/media/5758708/指定勞動基準法第36條第4項行業.pdf)的勞工可能會排除「七休一」，並不是所有勞工都將「連續工作十二天」。\n\n#### 法條演進\n\n1984 年《勞基法》草創時，第 36 條就明定「勞工每七日中至少應有一日之休息，作為例假。」但1986年內政部長吳伯雄就發出函釋說明「例假日原則上應間隔六個工作日」（七休一），如有必要可在工會或勞工同意後，「於各該週期內酌情更動」（十四休二）。可以說「七休一」制度在1986年後就名存實亡了。\n\n直至2016年6月民進黨立委鍾孔炤於立法院質詢時，要求勞動部廢止該函釋並獲委員會通過，勞動部才於6月29日[廢止舊函釋](https://www.mol.gov.tw/media/3809646/1050629-廢止內政部75年5月17日398001號函令.pdf)。其後，勞動部於9月10日[發布新函釋](https://www.mol.gov.tw/media/3809951/105年9月10日勞動條3字第1050132134號令.pdf)，明定必須在特定條件下雇主才能要求勞工連續工作十二天。\n\n#### 修法影響\n\n這次新《勞基法》則是將放寬「七休一」的過程明文化，需要是[勞動部指定之行業](https://www.mol.gov.tw/media/5758708/指定勞動基準法第36條第4項行業.pdf)，再經工會或勞資會議同意後，才能讓勞工連續上班十二天（十四休二）。不過法律條文並未明定勞動部需要經由什麼程序指定可放寬七休一的行業，雖然目前僅有部分勞工會放寬「七休一」，但在現行台灣工會比例和勞權意識仍有待加強的情況下，反對修法者質疑這恐怕會讓「七休一」徹底失守，這次修法恐怕會讓勞動現場全面回歸「十四休二」。'
        }
      ]
    },
    {
